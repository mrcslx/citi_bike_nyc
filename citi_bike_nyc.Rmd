...
The aim of the report is to assist with answering the following questions:

- do bike hires follow any kind of pattern over time?
- do bike rider demographics have an impact on bike hire patterns?
- what potential steps could be taken to improve Citi Bike's business?
...
Through the use of analysis and key data visualisations, this report will help Citi Bike NYC decide on potential new marketing strategies as well as infrastructure changes and future expansion.
...
Prior to any cleaning or wrangling, the dataset contains the following variable types: datetime, double (numerical variable which can represent fractional as well as whole values) and factor (used to represent categorical data, either ordered or unordered).

Columns of the following variable types are added through cleaning and wrangling: date and integer (real numbers which do not have fractional values).
